...
class JuniorDeveloper extends Developer {
    ...
    code() {
        console.log(`Junior разработчик пишет код ${this.technologies}`);
    }
}
...
class MiddleDeveloper extends Developer {
    ...
    code() {
        console.log(`Middle разработчик пишет код ${this.technologies}`);
    }
}
...
class SeniorDeveloper extends Developer {
    ...
    code() {
        console.log(`Senior разработчик пишет код ${this.technologies}`);
    }
}
